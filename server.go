...
// Inside of init() call gospf.OnAppStart() for each function you wish to register.
//
// Example:
//
...
//          gospf.OnAppStart(InitDB)
//          gospf.OnAppStart(FillCache)
//      }
//
// This can be useful when you need to establish connections to databases or third-party services,
// setup app components, compile assets, or any thing you need to do between starting gospf and accepting connections.
//
